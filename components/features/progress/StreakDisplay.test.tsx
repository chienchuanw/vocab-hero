...
describe('StreakDisplay', () => {
  it('should display current streak', () => {
    render(<StreakDisplay currentStreak={7} longestStreak={10} freezesRemaining={2} />);
  ...
  it('should display longest streak', () => {
    render(<StreakDisplay currentStreak={5} longestStreak={15} freezesRemaining={2} />);
  ...
  it('should display freezes remaining', () => {
    render(<StreakDisplay currentStreak={5} longestStreak={10} freezesRemaining={3} />);
  ...
  it('should display zero values correctly', () => {
    render(<StreakDisplay currentStreak={0} longestStreak={0} freezesRemaining={0} />);
  ...
  it('should highlight milestone achievements', () => {
    render(<StreakDisplay currentStreak={30} longestStreak={30} freezesRemaining={2} />);

    const streakElements = screen.getAllByText('30');
  ...
  it('should display warning when no freezes remaining', () => {
    render(<StreakDisplay currentStreak={5} longestStreak={10} freezesRemaining={0} />);
