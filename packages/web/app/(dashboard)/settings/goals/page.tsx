    ...
    <div className="container max-w-2xl py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure your daily learning objectives</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
              />
              <p className="text-sm text-muted-foreground">Time to receive daily study reminders</p>
            </div>
